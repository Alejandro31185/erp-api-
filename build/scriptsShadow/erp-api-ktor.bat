...
set CLASSPATH=%APP_HOME%\lib\erp-api-ktor-all.jar

@rem Execute erp-api-ktor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ERP_API_KTOR_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%ERP_API_KTOR_EXIT_CONSOLE%" exit 1
exit /b 1
